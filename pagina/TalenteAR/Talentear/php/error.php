...
<body>
    <div class="navbar">
        ...
        <div class="box-container">
            <a href="../../TalenteARpartners/php/registerpartners.php" class="box redirect">
                ¿Eres una agencia?
            </a>
        </div>
    </div>
...
switch ($error_code) {
    case 401:
        ...
        <br> Seguramente entraste sin primero haber iniciado tu sesión, para iniciar sesión haz clic <a href='login.php'>aquí.</a> 
...
<footer class="footer">
        ...
        <div class="footer-links">
            <a href="/TalenteARpartners/html/terminosycondiciones-partners.html">Términos y Condiciones</a><a class="guion-footer">-</a>
            <a href="partners.html">Política de Privacidad</a><a class="guion-footer">-</a>
            <a href="partners.html">Dirección física</a>
        </div>
